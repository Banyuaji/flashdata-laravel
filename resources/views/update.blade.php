...
<body>
    <div class="container">
        <a href="{{ route('siswa') }}" class="btn btn-primary my-3">&larr; Kembali</a>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('update', $siswa->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nipd" id="title" class="form-control" value="{{ $siswa->nipd }}" required>
                    </div>
                    <div class="form-group">
                        <label for="title">Nama</label>
                        <input type="text" name="nama_siswa" id="title" class="form-control" value="{{ $siswa->nama_siswa }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jurusan" id="title" class="form-control" value="{{ $siswa->jurusan }}">
                    </div>
                    <div class="form-group">
